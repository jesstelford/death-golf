...
export class Ball extends Entity {
  ...
  constructor() {
    ...
    this.body.applyField(new Vector(0, Settings.gravity / this.body.invMass));
    this.body.staticFrictionCoefficient = Settings.ballStaticFriction;
    this.body.dynamicFrictionCoefficient = Settings.ballDynamicFriction;
  }
