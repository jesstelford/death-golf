...
class Example2 extends State {
  ...
  initBodies() {
    this.movingBodies = [
      new Body(0).setOrigin(-0.7, 0.5).setMass(0.5).finalize(),
...
class Example3 extends State {
  ...
  initBodies() {
    ...
    this.fixedBodies = [
      new FixedBody(3).setOrigin(0, 0.6).setDimension(2, 0.2).finalize(),
      new FixedBody(4).setOrigin(0, -0.6).setDimension(2, 0.2).finalize(),
